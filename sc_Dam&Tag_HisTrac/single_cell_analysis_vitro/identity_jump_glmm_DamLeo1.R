# ============================================================
# Identity jump GLMM for Dam-Leo1
#
# Input example:
#   combined.obj.ls_DamLeo1$Dam_bb
#
# Comparison type:
# - Snapshot vs HisTrac
#
...
# Input
# --------------------
combined.obj.ls_DamLeo1 <- readRDS("path_to_DamLeo1/Dam_Leo1_D2_D7_D7R.rds")
obj <- combined.obj.ls_DamLeo1$Dam_bb
...
# Output files
# --------------------
out_csv_rates <- "IdentityJump_rates_DamLeo1.csv"
out_csv_glmm  <- "IdentityJump_GLMM_DamLeo1.csv"
