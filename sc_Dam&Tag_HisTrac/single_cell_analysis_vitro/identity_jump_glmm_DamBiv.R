# ============================================================
# Identity jump GLMM for Dam-Biv
#
# Input example:
#   combined.obj.ls_DamBiv$Dam_bb
#
# Comparison type:
# - Snapshot vs HisTrac
#
...
#   Snapshot cells (Day2 + Day7) in the Dam-Biv dataset?
#
# Analytical premise:
...
# Group definition:
# - Snapshot:
#     Day2rep1, Day2rep2, Day7rep1, Day7rep2
# - HisTrac:
#     Day7Rrep1, Day7Rrep2
#
# Model:
...
# Input
# --------------------
combined.obj.ls_DamBiv <- readRDS("path_to_DamBiv/Dam_Leo1_D2_D7_D7R.rds")
obj <- combined.obj.ls_DamBiv$Dam_bb
...
snap_ids <- c("Day2rep1", "Day2rep2", "Day7rep1", "Day7rep2")

# --------------------
# Output files
# --------------------
out_csv_rates <- "IdentityJump_rates_DamBiv.csv"
out_csv_glmm  <- "IdentityJump_GLMM_DamBiv.csv"
