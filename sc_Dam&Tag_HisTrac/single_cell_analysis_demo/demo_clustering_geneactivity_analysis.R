...
# Seurat object was prepared by demo_Seurat_object_preparation.R
combined.obj.ls <-readRDS("combined.obj.ls.demo.rds")
...
saveRDS(combined.obj.ls, file = "combined.obj.ls_analysis.demo.rds")
